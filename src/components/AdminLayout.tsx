...
import {
  ...
  BarChart3, Wallet, Megaphone, UserCog, CreditCard, Scale
} from "lucide-react";
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: bn ? "সেন্ট্রাল একাউন্টস" : "Central Accounts", url: "/admin/accounts", icon: Scale },
        { title: bn ? "অফিস খরচ" : "Office Expenses", url: "/admin/expenses", icon: Receipt },
